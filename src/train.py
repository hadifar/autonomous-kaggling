...
def build_model() -> XGBClassifier:
    ...
    return XGBClassifier(
        max_depth=6,
        learning_rate=0.06343144087990309,
        subsample=0.8918424713352255,
        colsample_bytree=0.7825344828131279,
        min_child_weight=54,
        reg_lambda=0.0774211647399625,
        reg_alpha=0.0003008686821445848,
        gamma=0.0712818805840136,
        max_bin=512,
        n_estimators=405,
